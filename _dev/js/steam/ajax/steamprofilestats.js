...
function SteamProfile() {
	...
	this.load = function(profileID) {
		...
		// create profile base
		profile = $('<span class="steamprofile"></span>');
	...
	function createProfile(profileData) {
		...
		profile.find('.steamstats_avatar img').attr('src', profileData.avatar);
		...
		{
			profile.find('.steamstats_avatar img').attr('class', 'steamstats_avatar ingame');
		...
		else
		{
			...
			switch (profileData.personastate)
			{
				...
				profile.find('.sp-badge').addClass('sp-' + langData[langLocal].profile_visibilities[0]);
						break;
				default: 
				profile.find('.steamstats_avatar img').attr('class', 'steamstats_avatar online');
				profile.find('.sp-badge').addClass('sp-' + langData[langLocal].profile_visibilities[1]);
			}
		}
		...
		*/
		...
		profile.find('.steamstats_avatar a, .sp-info a.sp-name').attr('href', 'http://steamcommunity.com/profiles/' + profileData.steamid);
